...
def scan_weather(argv, command_words=None):
    ...
    operands, given, rest = parse_tokens(argv, _OPTIONS_weather, None, command_split=(0, 0, frozenset({'report', 'sync', 'version', 'forecast', 'help'})))
